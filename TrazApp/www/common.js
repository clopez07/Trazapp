...
/***/ 3322
/*!****************************************************!*\
  !*** ./src/app/services/calidad-entero.service.ts ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CalidadEnteroService: () => (/* binding */ CalidadEnteroService)
/* harmony export */ });
...
class CalidadEnteroService {
  constructor(http) {
    this.http = http;
    this.baseUrlCalidad = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/calidad_entero`;
    this.baseUrlDetalle = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/detalle_calidad`;
  }
  // ── Calidad Entero ────────────────────────────────────────────
  getAll() {
    return this.http.get(this.baseUrlCalidad);
  }
  getById(id) {
    return this.http.get(`${this.baseUrlCalidad}/${id}`);
  }
  create(calidad) {
    return this.http.post(this.baseUrlCalidad, calidad);
  }
  update(id, data) {
    return this.http.patch(`${this.baseUrlCalidad}/${id}`, data);
  }
  delete(id) {
    return this.http.delete(`${this.baseUrlCalidad}/${id}`);
  }
  // ── Detalle Calidad ───────────────────────────────────────────
  getDetalleByCalidad(idCalidad) {
    return this.http.get(`${this.baseUrlDetalle}?idCalidad=${idCalidad}`);
  }
  createDetalle(detalle) {
    return this.http.post(this.baseUrlDetalle, detalle);
  }
  static #_ = _staticBlock = () => (this.ɵfac = function CalidadEnteroService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || CalidadEnteroService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient));
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    token: CalidadEnteroService,
    factory: CalidadEnteroService.ɵfac,
    providedIn: 'root'
  }));
}
_staticBlock();
...
/***/ 2159
/*!**********************************************************!*\
  !*** ./src/app/services/clasificacion-tallas.service.ts ***!
  \**********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ClasificacionTallasService: () => (/* binding */ ClasificacionTallasService)
/* harmony export */ });
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/environments/environment */ 5312);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 4205);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ 3855);
...
class ClasificacionTallasService {
  constructor(http) {
    this.http = http;
    this.baseUrlClasif = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/clasificacion_tallas`;
    this.baseUrlDetalle = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/detalle_tallas`;
  }
  // ── Clasificación ─────────────────────────────────────────────
  getAll() {
    return this.http.get(this.baseUrlClasif);
  }
  getById(id) {
    return this.http.get(`${this.baseUrlClasif}/${id}`);
  }
  create(clasif) {
    return this.http.post(this.baseUrlClasif, clasif);
  }
  update(id, data) {
    return this.http.patch(`${this.baseUrlClasif}/${id}`, data);
  }
  delete(id) {
    return this.http.delete(`${this.baseUrlClasif}/${id}`);
  }
  // ── Detalle Tallas ────────────────────────────────────────────
  getDetalleByClasif(idClasif) {
    return this.http.get(`${this.baseUrlDetalle}?idClasif=${idClasif}`);
  }
  createDetalle(detalle) {
    return this.http.post(this.baseUrlDetalle, detalle);
  }
  static #_ = _staticBlock = () => (this.ɵfac = function ClasificacionTallasService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ClasificacionTallasService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient));
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    token: ClasificacionTallasService,
    factory: ClasificacionTallasService.ɵfac,
    providedIn: 'root'
  }));
}
_staticBlock();
...
class ClienteService {
  constructor(http) {
    this.http = http;
    this.baseUrl = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/clientes`;
  }
  getAll() {
    return this.http.get(this.baseUrl);
  }
  getActivos() {
    return this.http.get(`${this.baseUrl}?estado=activo`);
  }
  getById(id) {
  ...
  static #_ = _staticBlock = () => (this.ɵfac = function ClienteService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ClienteService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient));
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
...
/***/ 2775
/*!*******************************************!*\
  !*** ./src/app/services/finca.service.ts ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FincaService: () => (/* binding */ FincaService)
/* harmony export */ });
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/environments/environment */ 5312);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 4205);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ 3855);
...
class FincaService {
  constructor(http) {
    this.http = http;
    this.baseUrl = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/fincas`;
  }
  getAll() {
    return this.http.get(this.baseUrl);
  }
  getByCliente(idCliente) {
    return this.http.get(`${this.baseUrl}?idCliente=${idCliente}`);
  }
  getActivasByCliente(idCliente) {
    return this.http.get(`${this.baseUrl}?idCliente=${idCliente}&estado=activo`);
  }
  getById(id) {
    return this.http.get(`${this.baseUrl}/${id}`);
  }
  create(finca) {
    return this.http.post(this.baseUrl, finca);
  }
  update(id, data) {
    return this.http.patch(`${this.baseUrl}/${id}`, data);
  }
  ...
  static #_ = _staticBlock = () => (this.ɵfac = function FincaService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || FincaService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient));
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    token: FincaService,
    factory: FincaService.ɵfac,
    providedIn: 'root'
  }));
}
_staticBlock();
...
/***/ 1684
/*!********************************************!*\
  !*** ./src/app/services/laguna.service.ts ***!
  \********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LagunaService: () => (/* binding */ LagunaService)
/* harmony export */ });
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/environments/environment */ 5312);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 4205);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ 3855);
...
class LagunaService {
  constructor(http) {
    this.http = http;
    this.baseUrl = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/lagunas`;
  }
  getAll() {
    return this.http.get(this.baseUrl);
  }
  getByFinca(idFinca) {
    return this.http.get(`${this.baseUrl}?idFinca=${idFinca}`);
  }
  getActivasByFinca(idFinca) {
    return this.http.get(`${this.baseUrl}?idFinca=${idFinca}&estado=activo`);
  }
  getById(id) {
    return this.http.get(`${this.baseUrl}/${id}`);
  }
  create(laguna) {
    return this.http.post(this.baseUrl, laguna);
  }
  update(id, data) {
    return this.http.patch(`${this.baseUrl}/${id}`, data);
  }
  ...
  static #_ = _staticBlock = () => (this.ɵfac = function LagunaService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || LagunaService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient));
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    token: LagunaService,
    factory: LagunaService.ɵfac,
    providedIn: 'root'
  }));
}
_staticBlock();
...
/***/ 1095
/*!***************************************************!*\
  !*** ./src/app/services/muestra-sabor.service.ts ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MuestraSaborService: () => (/* binding */ MuestraSaborService)
/* harmony export */ });
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/environments/environment */ 5312);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 4205);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ 3855);
...
class MuestraSaborService {
  constructor(http) {
    this.http = http;
    this.baseUrlMuestra = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/muestras_sabor`;
    this.baseUrlDetalle = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/detalle_sabor`;
  }
  // ── Muestras Sabor ────────────────────────────────────────────
  getAll() {
    return this.http.get(this.baseUrlMuestra);
  }
  getById(id) {
    return this.http.get(`${this.baseUrlMuestra}/${id}`);
  }
  create(muestra) {
    return this.http.post(this.baseUrlMuestra, muestra);
  }
  update(id, data) {
    return this.http.patch(`${this.baseUrlMuestra}/${id}`, data);
  }
  // ── Detalle Sabor ─────────────────────────────────────────────
  getDetalleByMuestra(idMuestra) {
    return this.http.get(`${this.baseUrlDetalle}?idMuestra=${idMuestra}`);
  }
  createDetalle(detalle) {
    return this.http.post(this.baseUrlDetalle, detalle);
  }
  static #_ = _staticBlock = () => (this.ɵfac = function MuestraSaborService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || MuestraSaborService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient));
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    token: MuestraSaborService,
    factory: MuestraSaborService.ɵfac,
    providedIn: 'root'
  }));
}
_staticBlock();
...
/***/ 8627
/*!**************************************************!*\
  !*** ./src/app/services/tipo-defecto.service.ts ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TipoDefectoService: () => (/* binding */ TipoDefectoService)
/* harmony export */ });
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/environments/environment */ 5312);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 4205);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ 3855);
...
class TipoDefectoService {
  constructor(http) {
    this.http = http;
    this.baseUrl = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/tipos_defecto`;
  }
  getAll() {
    return this.http.get(this.baseUrl);
  }
  ...
  static #_ = _staticBlock = () => (this.ɵfac = function TipoDefectoService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || TipoDefectoService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient));
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    token: TipoDefectoService,
    factory: TipoDefectoService.ɵfac,
    providedIn: 'root'
  }));
}
_staticBlock();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TrazabilidadService: () => (/* binding */ TrazabilidadService)
/* harmony export */ });
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/environments/environment */ 5312);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 4205);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ 3855);
...
class TrazabilidadService {
  constructor(http) {
    this.http = http;
    this.baseUrlRecepcion = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/trazabilidad_recepcion`;
    this.baseUrlBins = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/detalle_bins`;
  }
  // ── Recepciones ──────────────────────────────────────────────
  getAllRecepciones() {
    return this.http.get(this.baseUrlRecepcion);
  }
  getRecepcionById(id) {
    return this.http.get(`${this.baseUrlRecepcion}/${id}`);
  }
  createRecepcion(recepcion) {
    return this.http.post(this.baseUrlRecepcion, recepcion);
  }
  updateRecepcion(id, data) {
    return this.http.patch(`${this.baseUrlRecepcion}/${id}`, data);
  }
  deleteRecepcion(id) {
    return this.http.delete(`${this.baseUrlRecepcion}/${id}`);
  }
  // ── Bins ──────────────────────────────────────────────────────
  getBinsByRecepcion(idRecepcion) {
    return this.http.get(`${this.baseUrlBins}?idRecepcion=${idRecepcion}`);
  }
  createBin(bin) {
    return this.http.post(this.baseUrlBins, bin);
  }
  updateBin(id, data) {
    return this.http.patch(`${this.baseUrlBins}/${id}`, data);
  }
  deleteBin(id) {
    return this.http.delete(`${this.baseUrlBins}/${id}`);
  }
  procesarBin(id) {
    const ahora = new Date();
    const horaInicioProceso = ahora.toTimeString().slice(0, 5); // HH:MM
    return this.http.patch(`${this.baseUrlBins}/${id}`, {
      horaInicioProceso,
      estado: 'procesado'
    });
  }
  static #_ = _staticBlock = () => (this.ɵfac = function TrazabilidadService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || TrazabilidadService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient));
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    token: TrazabilidadService,
    factory: TrazabilidadService.ɵfac,
    providedIn: 'root'
  }));
}
_staticBlock();
...
class UsuarioService {
  constructor(http) {
    this.http = http;
    this.baseUrl = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/usuarios`;
  }
  getAll() {
    return this.http.get(this.baseUrl);
  }
  getPanelistas() {
    return this.http.get(`${this.baseUrl}?rol=panelista&estado=activo`);
  }
  getInspectores() {
    return this.http.get(`${this.baseUrl}?rol=inspector&estado=activo`);
  }
  getVerificadores() {
    return this.http.get(`${this.baseUrl}?rol=verificador&estado=activo`);
  }
  getById(id) {
    return this.http.get(`${this.baseUrl}/${id}`);
  }
  ...
  static #_ = _staticBlock = () => (this.ɵfac = function UsuarioService_Factory(__ngFactoryType__) {
...
/* harmony export */ });
/* harmony import */ var _p_BJoMtgfR_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./p-BJoMtgfR.js */ 7788);
/* harmony import */ var _p_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./p-ZjP4CjeZ.js */ 291);
/*!
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_carloslopez_Downloads_ProgramacionWEBI_Trazapp_TrazApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
...
const createKeyboardController = /*#__PURE__*/function () {
  var _ref = (0,_Users_carloslopez_Downloads_ProgramacionWEBI_Trazapp_TrazApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (keyboardChangeCallback) {
    ...
    const init = /*#__PURE__*/function () {
      var _ref2 = (0,_Users_carloslopez_Downloads_ProgramacionWEBI_Trazapp_TrazApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
